...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'photo_mini.required' => 'O campo de foto de miniatura deve ser preenchido',
            'photo_mini.image' => 'O campo de foto de miniatura deve ser uma imagem',
            'brand_id.required' => 'A marca deve ser selecionada',
            'brand_id.exists' => 'A marca selecionada não existe no sistema',
            'category_id.required' => 'A categoria deve ser selecionada',
